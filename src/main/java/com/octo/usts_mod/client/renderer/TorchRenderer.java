...
public class TorchRenderer<L extends LivingEntity> implements ICurioRenderer {
    private static final ResourceLocation TORCH_TEXTURE = new ResourceLocation(USTS_Mod.MOD_ID,
            "textures/block/torch.png");
    private final HumanoidModel<LivingEntity> model;

    public TorchRenderer() {
        this.model = new TorchModel<>(Minecraft.getInstance().getEntityModels()
                .bakeLayer(CuriosLayerDefinitions.TORCH));
    }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack,
        ...
        this.renderLayer(matrixStack, renderTypeBuffer, light, stack.hasFoil(), this.model, TORCH_TEXTURE);
    }
